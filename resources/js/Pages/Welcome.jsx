                ...
                <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md">
                    <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-2">
                        <Link href="/" className="flex items-center gap-3 group">
                            <img 
                                src="/images/ormeasy-logo-dark.webp" 
                                alt="OrmEasy Car Rentals" 
                                className="min-h-[130px] h-[130px] w-auto object-contain"
                            />
                        </Link>
                    ...
                    <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row items-center justify-between gap-6">
                        <Link href="/" className="flex items-center gap-3 group">
                            <img 
                                src="/images/ormeasy-logo-dark.webp" 
                                alt="OrmEasy Car Rentals" 
                                className="min-h-[130px] h-[130px] w-auto object-contain opacity-90 group-hover:opacity-100 transition-opacity" 
                            />
